...
namespace pytorch_mesh_renderer
{
    ...
    // are rendered.
    __device__ const float kDegenerateBarycentricCoordinatesCutoff = 0.9f;
    ...
    __device__ const float kMinimumTriangleArea = 1e-13f;

    // The derivative of RasterizeTrianglesForward function
    void RasterizeTrianglesBackwardCuda(
        at::Tensor vertices,
        at::Tensor triangles,
        at::Tensor barycentric_coordinates,
        at::Tensor triangle_ids,
        at::Tensor df_dbarycentric_coordinates,
        int32_t image_width,
        int32_t image_height,
